...
public class Clinic {
    ...
    @Indexed(unique = true)
    private String clinicId; // Business ID (e.g., CLINIC001)

    /**
     * ✅ Added to facilitate Doctor-specific ownership and filtering.
     * This field stores the ID of the doctor who registered the clinic.
     */
    ...
    // -------- DOCTOR INFO --------
    private List<Doctor> doctors; // List of all doctors practicing at this clinic
    ...
    /** ✅ Getter and Setter for the new doctorId ownership field **/
    public String getDoctorId() { return doctorId; }
    public void setDoctorId(String doctorId) { this.doctorId = doctorId; }
    ...
    public void setAppointmentRequired(Boolean appointmentRequired) { this.appointmentRequired = appointmentRequired; }
